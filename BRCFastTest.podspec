...
Pod::Spec.new do |s|
  s.name             = 'BRCFastTest'
  s.version          = '0.1.0'
  s.summary          = 'A short description of BRCFastTest.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/zhixiongsun/BRCFastTest'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'zhixiongsun' => 'zhixiongsun@trip.com' }
  s.source           = { :git => 'https://github.com/zhixiongsun/BRCFastTest.git', :tag => s.version.to_s }
